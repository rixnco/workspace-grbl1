  ...
  function() {
    ...
    cprequire(
      ...
      function(myWorkspaceRix) {
        ...
        console.log("Workspace / grbl just got loaded.", myWorkspaceRix);
        myWorkspaceRix.init();
      }
    );
  }
