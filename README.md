# com-chilipeppr-workspace-rix
RIX's grbl 1.1 Workspace.



## ChiliPeppr Workspace / Rix
...
| Item                  | Value           |
| -------------         | ------------- | 
| ID                    | com-chilipeppr-workspace-rix |
| Name                  | Workspace / Rix |
| Description           | RIX's grbl 1.1 Workspace. |
| chilipeppr.load() URL | http://raw.githubusercontent.com/rixnco/workspace-rix/master/auto-generated-workspace.html |
| Edit URL              | http://ide.c9.io/undefined/undefined |
| Github URL            | http://github.com/rixnco/workspace-rix |
...
chilipeppr.load(
  "#pnlWorkspace",
  "http://raw.githubusercontent.com/rixnco/workspace-rix/master/auto-generated-workspace.html",
  function() {
    // Callback after workspace loaded into #pnlWorkspace
    // Now use require.js to get reference to instantiated workspace
    cprequire(
      ["inline:com-chilipeppr-workspace-rix"], // the id you gave your workspace
      function(myWorkspaceRix) {
        // Callback that is passed reference to the newly loaded workspace
        console.log("Workspace / Rix just got loaded.", myWorkspaceRix);
        myWorkspaceRix.init();
      }
    );
  }
...
The table below shows, in order, the methods and properties inside the workspace object.
  ...
  <table id="com-chilipeppr-elem-methodsprops" class="table table-bordered table-striped">
      ...
      <tbody>
      <tr valign="top"><td>id</td><td>string</td><td>"com-chilipeppr-workspace-rix"<br><br>The ID of the widget. You must define this and make it unique.</td></tr><tr valign="top"><td>name</td><td>string</td><td>"Workspace / Rix"</td></tr><tr valign="top"><td>desc</td><td>string</td><td>"RIX's grbl 1.1 Workspace."</td></tr><tr valign="top"><td>url</td><td>string</td><td>"http://raw.githubusercontent.com/rixnco/workspace-rix/master/auto-generated-workspace.html"</td></tr><tr valign="top"><td>fiddleurl</td><td>string</td><td>"http://ide.c9.io/undefined/undefined"</td></tr><tr valign="top"><td>githuburl</td><td>string</td><td>"http://github.com/rixnco/workspace-rix"</td></tr><tr valign="top"><td>testurl</td><td>string</td><td>"http://undefined-undefined.c9users.io/workspace.html"</td></tr><tr valign="top"><td>widgetConsole</td><td>object</td><td>Contains reference to the Console widget object. Hang onto the reference
