...
cprequire_test(["inline:com-chilipeppr-workspace-rix"], function(ws) {
...
cpdefine("inline:com-chilipeppr-workspace-rix", ["chilipeppr_ready"], function() {
    return {
        /**
        ...
        loadWidgets: function(callback) {
            ...
            var touchPlateObj = {
                ...
                init: function() {
                    ...
                    this.setupBtn();
                    console.log("Yop !! done instantiating touchPlate add-on widget");
                },
                setupBtn: function() {
                    ...
                    cprequire(
                        ...
                        function(xyz) {
                            ...
                            xyz.setGrblVersion = function(version) {
                                console.log("setGRBL version: "+xyz.grblVersion);
                            ...
                            $('#com-chilipeppr-widget-xyz-ftr .joggotozero').attr("data-content", "G0 X0 Y0<br/>If you need to go to X0 Y0 first and then Z0, you can use the menus on the axes above.");
                            ...
                            $('#com-chilipeppr-widget-xyz-ftr .joghomem').attr("data-content", "$H homing cycle - Must have limit switches and homing enabled in GRBL settings");

                            $('#com-chilipeppr-widget-xyz-ftr .joggotozerom').hide();
                            $('#com-chilipeppr-widget-xyz-ftr .jogzerooutm').hide();
            ...
            chilipeppr.load(
                ...
                "http://raw.githubusercontent.com/rixnco/grbl1-widget/master/auto-generated-widget.html",
                function() {
                    cprequire(
